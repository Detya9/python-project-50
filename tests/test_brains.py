...
def test_generate_diff():
    ...
    json_path1 = 'tests/fixtures/json_f1_f2.txt'
    with open(stylish_path1, encoding='utf-8') as stylish_1, \
        ...
        assert generate_diff(json1_path, yml2_path, 'json') == json1
